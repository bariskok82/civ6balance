...
INSERT INTO Improvement_Adjacencies(ImprovementType, YieldChangeId) VALUES
	('IMPROVEMENT_PYRAMID', 'Pyramid_CityCenterAdjacency2_BK82');
...
INSERT INTO Adjacency_YieldChanges(ID, Description, YieldType, YieldChange, TilesRequired, AdjacentDistrict) VALUES
	('Pyramid_CityCenterAdjacency2_BK82', 'Placeholder', 'YIELD_PRODUCTION', 1, 1, 'DISTRICT_CITY_CENTER');
...
INSERT INTO Modifiers(ModifierId, ModifierType) VALUES
	('TRAIT_LEADER_PILLAGE_SCIENCE_QUARRIES_BK82', 'MODIFIER_PLAYER_ADJUST_ADDITIONAL_PILLAGING');
INSERT INTO ModifierArguments(ModifierId, Name, Value) VALUES
	('TRAIT_LEADER_PILLAGE_SCIENCE_QUARRIES_BK82', 'PlunderType', 'PLUNDER_SCIENCE'),
	('TRAIT_LEADER_PILLAGE_SCIENCE_QUARRIES_BK82', 'ImprovementType', 'IMPROVEMENT_QUARRY'),
	('TRAIT_LEADER_PILLAGE_SCIENCE_QUARRIES_BK82', 'Amount', 15);
...
INSERT INTO TraitModifiers(TraitType, ModifierId) VALUES
	('TRAIT_LEADER_MELEE_COASTAL_RAIDS', 'TRAIT_LEADER_PILLAGE_SCIENCE_QUARRIES_BK82');
